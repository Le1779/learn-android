...
public class NaturalWindButton extends ShadowButton {
    private AppCompatImageView image;
    private boolean isOn = true;

    public NaturalWindButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void generateImage() {
        ...
        image.setImageResource(R.drawable.ic_leaf);
    ...
    private void updateStatus() {
        int filterColor = isOn && isEnabled() ? Color.parseColor("#4CAF50") : ContextCompat.getColor(getContext(), R.color.dark_gray_5);
