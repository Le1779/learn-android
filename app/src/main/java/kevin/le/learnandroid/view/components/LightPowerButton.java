...
public class LightPowerButton extends ShadowButton {

    private AppCompatImageView image;
    private View lightView;
    private boolean isOn = true;

    public LightPowerButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void generateImage() {
        ...
        image.setImageResource(R.drawable.ic_lightbulb);
