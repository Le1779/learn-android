...
public class ClockDirectionButton extends ShadowButton {
    private AppCompatImageView image;
    private boolean clockwise = true;
    private boolean isOn = true;

    public ClockDirectionButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void updateStatus() {
        image.setImageResource(clockwise ? R.drawable.ic_clockwise : R.drawable.ic_counter_clockwise);
